...
class Container_f550f6e760 extends Nette\DI\Container
{
	protected $meta = [
		'types' => [
	...
	/**
	 * @return App\CoreModule\Model\ItemManager
	 */
	public function createService__25_App_CoreModule_Model_ItemManager()
	{
	 ...
	 */
	public function createService__27_App_Forms_SignInFormFactory()
	{
	 ...
	 */
	public function createService__28_App_Forms_SignUpFormFactory()
	{
	 ...
	 */
	public function createService__30_Nette_Utils_DateTime()
	{
	 ...
	 */
	public function createService__31_App_CoreModule_Presenters_ContactPresenter()
	{
	...
	/**
	 * @return App\CoreModule\Presenters\ItemPresenter
	 */
	public function createService__32_App_CoreModule_Presenters_ItemPresenter()
	{
	...
	{
		$service = new Nette\Database\Connection('mysql:host=127.0.0.1;dbname=kosmonauti', 'root', null, ['lazy' => true]);
	...
	{
		return new Container_f550f6e760_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory($this);
	}
...
class Container_f550f6e760_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory implements Nette\Bridges\ApplicationLatte\ILatteFactory
{
	private $container;


	public function __construct(Container_f550f6e760 $container)
	{
