<?php
// source: C:\xampp\htdocs\todo_nette\app/config/config.neon 
// source: C:\xampp\htdocs\todo_nette\app/config/config.local.neon 

class Container_e847644f1f extends Nette\DI\Container
{
	protected $meta = [
		'types' => [
			...
			'App\Model\DatabaseManager' => [1 => ['25_App_CoreModule_Model_TaskManager', 'authenticator']],
			'App\CoreModule\Model\TaskManager' => [1 => ['25_App_CoreModule_Model_TaskManager']],
			...
			'App\Presenters\BasePresenter' => [
				1 => [
					...
					'32_App_CoreModule_Presenters_TaskPresenter',
					'application.1',
					'application.2',
					'application.4',
					'application.5',
			...
			'App\CoreModule\Presenters\TaskPresenter' => [1 => ['32_App_CoreModule_Presenters_TaskPresenter']],
		...
		'services' => [
			'25_App_CoreModule_Model_TaskManager' => 'App\CoreModule\Model\TaskManager',
			...
			'32_App_CoreModule_Presenters_TaskPresenter' => 'App\CoreModule\Presenters\TaskPresenter',
		...
		'tags' => [
			'inject' => [
				...
				'32_App_CoreModule_Presenters_TaskPresenter' => true,
				'application.1' => true,
				'application.2' => true,
				'application.3' => true,
				'application.4' => true,
	...
	public function __construct(array $params = [])
	{
		...
		$this->parameters += [
			'appDir' => 'C:\xampp\htdocs\todo_nette\app',
			'wwwDir' => 'C:\xampp\htdocs\todo_nette\www',
			'debugMode' => true,
			'productionMode' => false,
			'consoleMode' => false,
			'tempDir' => 'C:\xampp\htdocs\todo_nette\app/../temp',
			'defaultTaskUrl' => 'uvod',
	...
	public function createService__25_App_CoreModule_Model_TaskManager(): App\CoreModule\Model\TaskManager
	{
		$service = new App\CoreModule\Model\TaskManager($this->getService('database.default.context'));
		return $service;
	}
	...
	public function createService__32_App_CoreModule_Presenters_TaskPresenter(): App\CoreModule\Presenters\TaskPresenter
	{
		$service = new App\CoreModule\Presenters\TaskPresenter('uvod', $this->getService('25_App_CoreModule_Model_TaskManager'));
		$service->injectPrimary(
			$this,
			$this->getService('application.presenterFactory'),
			$this->getService('routing.router'),
	...
	public function createServiceApplication__presenterFactory(): Nette\Application\IPresenterFactory
	{
		$service = new Nette\Application\PresenterFactory(new Nette\Bridges\ApplicationDI\PresenterFactoryCallback(
			$this,
			5,
			'C:\xampp\htdocs\todo_nette\app/../temp/cache/Nette%5CBridges%5CApplicationDI%5CApplicationExtension'
		));
	...
	{
		$service = new Nette\Caching\Storages\SQLiteJournal('C:\xampp\htdocs\todo_nette\app/../temp/cache/journal.s3db');
		return $service;
	}
	...
	{
		$service = new Nette\Caching\Storages\FileStorage('C:\xampp\htdocs\todo_nette\app/../temp/cache', $this->getService('cache.journal'));
		return $service;
	}
	...
	{
		$service = new Nette\Database\Connection('mysql:host=127.0.0.1;dbname=todo_nette', 'root', null, ['lazy' => true]);
	...
	public function createServiceLatte__latteFactory(): Nette\Bridges\ApplicationLatte\ILatteFactory
	{
		return new class ($this) implements Nette\Bridges\ApplicationLatte\ILatteFactory {
			...
			public function __construct(Container_e847644f1f $container)
			{
			...
			public function create(): Latte\Engine
			{
				...
				$service->setTempDirectory('C:\xampp\htdocs\todo_nette\app/../temp/cache/latte');
	...
	public function createServiceSecurity__authorizator(): Nette\Security\IAuthorizator
	{
		...
		$service->allow('guest', 'Core:Task', 'default');
		$service->allow('guest', 'Core:Task', 'list');
